package com.SPM.backend.IT20122096.LoginRegistrationAuth.Service;
...
import com.SPM.backend.IT20122096.LoginRegistrationAuth.Repository.UserRepository;
...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User user = userRepository.findUserByEmail(email);
    ...
    @Override
    public ResponseEntity<List<com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User>> getAllUsers() {
        List<com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User> allUsers = userRepository.findAll();
    ...
    public ResponseEntity<?> getUserById(ObjectId id) {
        Optional<com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User> user = userRepository.findById(id);
        if (user.isPresent()) {
    ...
    public ResponseEntity<?> saveUser(UserRegisterDTO userRegisterDTO) {
        ...
        com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User user = userRepository.findUserByEmail(userRegisterDTO.getEmail());
        if (user != null) {
            return new ResponseEntity<>("User Already Exist", HttpStatus.BAD_REQUEST);
        }

        if (userRegisterDTO.getIsAdmin()) {
            com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User admin = new Admin(
        ...
        com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User visitor = new com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User(
    ...
    public ResponseEntity<?> updateUser(UserUpdateDTO userDTO) {
        ...
        Optional<com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User> user1 = userRepository.findById(userDTO.getId());
        if(user1.isPresent()){
            com.SPM.backend.IT20122096.LoginRegistrationAuth.Entity.User user = user1.get();
